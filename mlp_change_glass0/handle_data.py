...
def next_batch(train_data, train_label, pairsize=2, seq_length=1):
    x_examples      = []
    x_2_examples    = []
    y_examples      = []
    y_2_examples    = []
    ...
    index = random.randint(0, length - seq_length)

    x_examples.append(train_data[index : index + seq_length])
    y_examples.append(train_label[index : index + seq_length])


    if train_label[index] > 0:
        negative_idx = random.randint(0, negative_length - seq_length)
        x_2_examples.append(negative_data[negative_idx : negative_idx + seq_length])
        y_2_examples.append([0])
        t_examples.append([1])
    else:
        positive_idx = random.randint(0, positive_length - seq_length)
        x_2_examples.append(positive_data[positive_idx : positive_idx + seq_length])
        y_2_examples.append([1])
        t_examples.append([0])
    return x_examples, x_2_examples, y_examples, y_2_examples, t_examples
